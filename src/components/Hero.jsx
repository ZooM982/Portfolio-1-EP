...
const Hero = () => {
	...
	return (
		<>
			<Helmet>
				<title>
					{t("hero.about")} - {t("navbar.developer")}
				</title>
			...
			<section className="bg-gradient-to-b from-gray-50 to-white dark:from-gray-800 dark:to-gray-900">
				<motion.section
					...
					className="py-[83.5px] flex items-center justify-center"
				>
					<div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center gap-12">
						...
						<div className="text-center md:text-left space-y-6 max-w-lg">
							...
							>
								<Link
									to="/about"
									className="px-6 py-3 bg-[#fa2f0b] text-white rounded-lg hover:bg-red-700 transition duration-300"
								>
									{t("navbar.cv")}
								</Link>
								<Link
									to="/projects"
									className="px-6 py-3 border border-[#fa2f0b] text-[#fa2f0b] rounded-lg hover:bg-red-50 dark:hover:bg-gray-700 transition duration-300"
								>
									{t("navbar.projects")}
								</Link>
								<Link
